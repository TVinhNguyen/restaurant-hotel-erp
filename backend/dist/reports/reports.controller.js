...
let ReportsController = class ReportsController {
    ...
    async getDashboardSummary(startDate, endDate, propertyId) {
        const queryDto = { startDate, endDate, propertyId };
        return this.reportsService.getDashboardSummary(queryDto);
    }
    async getOccupancyReport(startDate, endDate, propertyId) {
        const queryDto = { startDate, endDate, propertyId };
        return this.reportsService.getOccupancyReport(queryDto);
    }
    async getRevenueReport(startDate, endDate, propertyId, roomTypeId) {
        const queryDto = { startDate, endDate, propertyId, roomTypeId };
        return this.reportsService.getRevenueReport(queryDto);
    }
    async getRestaurantReport(startDate, endDate, propertyId, restaurantId) {
        const queryDto = { startDate, endDate, propertyId, restaurantId };
        return this.reportsService.getRestaurantReport(queryDto);
    }
    async getPerformanceMetrics(startDate, endDate, propertyId) {
        const queryDto = { startDate, endDate, propertyId };
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, String, String]),
    __metadata("design:returntype", Promise)
], ReportsController.prototype, "getRestaurantReport", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", Promise)
], ReportsController.prototype, "getPerformanceMetrics", null);
