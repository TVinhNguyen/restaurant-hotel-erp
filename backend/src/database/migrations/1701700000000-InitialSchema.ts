...
export class InitialSchema1701700000000 implements MigrationInterface {
  name = 'InitialSchema1701700000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS core.employees (
        ...
        department VARCHAR(50) CHECK (department IN ('Front Desk','Housekeeping','HR','F&B')),
    ...
    // Initial indexes from pms_init.sql
    await queryRunner.query(`
    ...
    await queryRunner.query(`
      ...
      ON reservation.payments(reservation_id)
    `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
      ...
      ON inventory.rooms(property_id, operational_status)
    `);
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_table_bookings_restaurant_date 
      ON restaurant.table_bookings(restaurant_id, booking_date)
    `);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop all tables in reverse order of dependencies
    await queryRunner.query('DROP TABLE IF EXISTS hr.deductions CASCADE');
    await queryRunner.query('DROP TABLE IF EXISTS hr.overtimes CASCADE');
    await queryRunner.query('DROP TABLE IF EXISTS hr.payrolls CASCADE');
    await queryRunner.query(
      'DROP TABLE IF EXISTS hr.employee_evaluations CASCADE',
    );
    await queryRunner.query('DROP TABLE IF EXISTS hr.leaves CASCADE');
    await queryRunner.query('DROP TABLE IF EXISTS hr.attendance CASCADE');
    await queryRunner.query('DROP TABLE IF EXISTS hr.working_shifts CASCADE');
    await queryRunner.query(
      'DROP TABLE IF EXISTS restaurant.table_bookings CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS restaurant.restaurant_tables CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS restaurant.restaurant_areas CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS restaurant.restaurants CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.reservation_services CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.payments CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.reservations CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.tax_rules CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.promotions CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.property_services CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.services CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.daily_rates CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS reservation.rate_plans CASCADE',
    );
    await queryRunner.query(
      'DROP TABLE IF EXISTS inventory.room_status_history CASCADE',
    );
    await queryRunner.query('DROP TABLE IF EXISTS inventory.rooms CASCADE');
    await queryRunner.query('DROP TABLE IF EXISTS inventory.photos CASCADE');
    await queryRunner.query(
      'DROP TABLE IF EXISTS inventory.room_type_amenities CASCADE',
    );
    await queryRunner.query('DROP TABLE IF EXISTS inventory.amenities CASCADE');
    await queryRunner.query(
      'DROP TABLE IF EXISTS inventory.room_types CASCADE',
    );
    await queryRunner.query('DROP TABLE IF EXISTS core.properties CASCADE');
    await queryRunner.query('DROP TABLE IF EXISTS core.guests CASCADE');
    await queryRunner.query('DROP TABLE IF EXISTS core.employee_roles CASCADE');
    ...
    await queryRunner.query('DROP SCHEMA IF EXISTS restaurant');
    await queryRunner.query('DROP SCHEMA IF EXISTS reservation');
